  ...
  useEffect(() => {
    if (usersData || adminStats) {
      setStats(prev => ({
        ...
        totalPredictions: adminStats
          ? adminStats.totalPredictions
          : prev.totalPredictions,
        predictions: adminStats ? adminStats.predictions : prev.predictions,
        registrations: {
          last30Days: adminStats
            ? adminStats.registrationsLast30Days
            : prev.registrations.last30Days
        }
      }));
    }
        ...
        <Stack spacing={3}>
          <Card>
            <CardContent>
              ...
              <Divider sx={{ mb: 2 }} />
              <Typography>
                Per day: {stats.predictions.volume.perDay}
              </Typography>
              <Typography>
                Diabetes: {stats.predictions.volume.diabetes}
              </Typography>
